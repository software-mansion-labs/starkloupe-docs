...
Starkloupe Call Trace supports three types of calls: `CALL`, `DELEGATE`, and `FUNCTION`. Each represents a specific type of contract interaction on Starknet.

:::info Frames
Each call item in a Starkloupe Call Trace is a "Frame." Frames represent the sequence of calls within a transaction.
:::
...
[See an example transaction with a `CALL` frame.](https://app.starkloupe.co/transactions?chainId=SN_MAINNET&txHash=0x078297c72690f36059621b68b33d207999be7fcc296586f6fda7d7b5fc9b0698)
...
[See an example transaction with a `DELEGATE` frame.](https://app.starkloupe.co/transactions?chainId=SN_MAINNET&txHash=0x048b4b35ba6c85582dae9681aa38ea9abdbc1d4286152ca8e8d23951c80efb9e)
...
[See an example transaction with a `FUNCTION` frame.](https://app.starkloupe.co/transactions?chainId=SN_MAINNET&txHash=0x07bb1d7f7a1c496347475e24e9156edc92640d37bb488cf9181f551a89a37aa2)

![FUNCTION Example](/img/call_trace_types/function_example.png)

:::info
Public explorers typically don't display `FUNCTION` calls in their Call Trace components because blockchain nodes don't provide this data. Starkloupe works around this by re-simulating each transaction to reconstruct the full trace, including internal operations, and displays the entire execution flow.
:::
